...
class PersonalEquipmentAssignmentDetail(models.Model):
    ...
    fkequipmentkind = models.ForeignKey(
        PersonalEquipmentType, on_delete=models.PROTECT)
    ...
    class Meta:
        constraints = [
            models.constraints.UniqueConstraint(
                fields=["fkuser", "fkequipmentkind"], name="one_piece_of_equipment_each", violation_error_message="Questo volontario ha già un oggetto di questo tipo")
        ]
